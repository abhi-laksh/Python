...
while cam.isOpened():
    ...
    if cntrs is not None or hull is not None:
        ...
        if(True):
            ...
            if count_defects == 2:
                cv2.putText(frame, "This is 1", (50, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
            elif count_defects == 3:
                cv2.putText(frame, "I am Abhishek", (50, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
            elif count_defects == 4:
                cv2.putText(frame, "This is 4 :P", (50, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
            elif count_defects == 5:
                cv2.putText(frame, "Hi!!!", (50, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
            else:
                cv2.putText(frame, "Please Don't Punch Me!!",
                            (2, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, 2)
    else:
